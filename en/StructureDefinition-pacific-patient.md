# Pacific Patient - Fiji Core Implementation Guide v0.2.0
...
```json
{
  ...
  "id" : "pacific-patient",
  "url" : "https://healthinfoservices.net/fiji-pacific-ig/StructureDefinition/pacific-patient",
  "version" : "0.2.0",
  "name" : "PacificPatient",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://healthinfoservices.net/fiji-pacific-ig/StructureDefinition/pacific-practitioner-role",
