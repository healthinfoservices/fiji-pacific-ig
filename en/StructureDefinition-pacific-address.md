# Pacific Address - Fiji Core Implementation Guide v0.1.0
...
```json
{
  ...
  "id" : "pacific-address",
  "url" : "https://healthinfoservices.net/pacific-core/StructureDefinition/pacific-address",
  "version" : "0.1.0",
  "name" : "PacificAddress",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://healthinfoservices.net/pacific-core/StructureDefinition/pacific-address-village"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://healthinfoservices.net/pacific-core/StructureDefinition/pacific-address-island"]
      }],
      "mustSupport" : true
    },
    {
