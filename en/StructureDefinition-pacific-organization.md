# Pacific Healthcare Organization - Fiji/Pacific Core Implementation Guide v0.2.1
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.uv.pacific.core|current/StructureDefinition/StructureDefinition-pacific-organization.json)
