# Fiji Organization Identifier - Fiji Core Implementation Guide v0.1.0
...
```json
{
  ...
  "extension" : [{
    ...
    "valueUri" : "https://healthinfoservices.net/pacific-core/NamingSystem/FijiOrganizationIdentifier"
  },
  {
