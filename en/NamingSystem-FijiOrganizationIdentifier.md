# Fiji Organization Identifier - Fiji/Pacific Core Implementation Guide v0.2.1
...
```json
{
  ...
  "extension" : [{
    ...
    "valueUri" : "https://healthinfoservices.net/fiji-pacific-ig/NamingSystem/FijiOrganizationIdentifier"
  },
  {
  ...
  "uniqueId" : [{
    "type" : "uri",
    "value" : "http://health.gov.fj/fhir/identifier/organization",
    "preferred" : true
  }]
}
