# Pacific Clan Affiliation - Fiji Core Implementation Guide v0.1.0
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://healthinfoservices.net/pacific-core/StructureDefinition/pacific-clan-affiliation"
    },
    {
