# Respiratory Rate Vitals (Pacific region) - Fiji Core Implementation Guide v0.2.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.pacific.core|current/StructureDefinition/pacific-vital-respiratory-rate)
...
```json
{
  ...
  "url" : "https://healthinfoservices.net/fiji-pacific-ig/StructureDefinition/pacific-vital-respiratory-rate",
  "version" : "0.2.0",
